<template>
  <div class="add-block" @touchmove.prevent>
    ...
    <div class="add-content">
      <div class="add-item">宝物：
        <el-input class="add-item-input" type="text" v-model="data.name" placeholder="输入宝物名称"></el-input>
      </div>
      <div class="add-item">数量：
        <el-input class="add-item-input" type="number" placeholder=" 数量" v-model="data.num"></el-input>
      </div>
      ...
      <div class="add-item">难度：
        <el-input class="add-item-input" type="number" placeholder=" 几星难度,可不填" v-model="data.level"></el-input>
      </div>
      <div class="add-item">加成：
        <el-input class="add-item-input" type="text" placeholder=" 加成，可不填" v-model="data.plus"></el-input>
      </div>
      <div class="add-item">
