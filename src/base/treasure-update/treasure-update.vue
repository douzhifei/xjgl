<template>
    <div class="update-block" @touchmove.prevent>
            ...
            <div class="update-content">
                <div class="update-item">宝物：<el-input class="update-item-input" type="text" v-model="data.name" placeholder="输入宝物名称"></el-input></div>
                <div class="update-item">数量：<el-input class="update-item-input" type="number" placeholder=" 数量"  v-model="data.num"></el-input></div>
                ...
                <div class="update-item">难度：<el-input class="update-item-input" type="number" placeholder=" 几星难度" v-model="data.level"></el-input></div>
                <div class="update-item">加成：<el-input class="update-item-input" type="text" placeholder=" 加成，可以不填" v-model="data.plus"></el-input></div>
