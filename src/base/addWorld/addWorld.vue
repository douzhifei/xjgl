<template>
  <div class="add-block" @touchmove.prevent>
    ...
    <div class="add-content">
      <div class="add-item">地图名称：
        <el-input class="add-item-input" type="text" v-model="data.name" placeholder="x界虚空探宝x"></el-input>
      </div>
      <div class="add-item">地图MapId：
        <el-input class="add-item-input" type="number" placeholder=" MapId" v-model="data.mapId"></el-input>
      </div>
      <div class="add-item">六界所属：
        <el-input class="add-item-input" type="text" placeholder=" 六界所属 " v-model="data.attach"></el-input>
      </div>
