<template>
    <div class="article">
        ...
        <div class="a-item a-title">标题：<el-input class="a-input" type="text" v-model="data.title" placeholder="输入标题"></el-input></div>
        <div class="a-item a-author">作者：<el-input class="a-input" type="text" v-model="data.author" placeholder="作者"></el-input></div>
        <div class="a-item a-cover">封面： 
            <el-upload
                class="a-input avatar-uploader"
                :action= domain
        ...
        <div class="a-item a-type">类型：<el-input class="a-input" type="number" v-model="data.type" placeholder="1公告2攻略3数据"></el-input></div>
        ...
        <div class="a-item a-goto">跳转path：<el-input class="a-input" type="text" v-model="data.goto" placeholder="path"></el-input></div>
        <div class="a-item a-top">排序：<el-input class="a-input" type="number" v-model="data.top" placeholder="默认0，数值越大越前"></el-input></div>
...
export default {
    ...
    mounted(){
        // this.$refs.editor.addEventListener('touchmove', func, { passive: false })
    },
    methods:{
    // 上传文件到七牛云
    upqiniu (req) {
