<template>
  <div class="treasure" ref="treasure">
    ...
    <treasure-add v-show="isOpenAdd" @sucess="addData" @addQuit="addQuit" :worlds="worlds"></treasure-add>
    <add-world v-show="isOpenAddWorld" @worldQuit="worldQuit"></add-world>
    <treasure-update v-show="isOpenUpdate" @updateSucess="updateData" @updateQuit="updateQuit" :data="udata" :worlds="worlds" :toSite="changeRange(udata.range)"></treasure-update>
  </div>
</template>
