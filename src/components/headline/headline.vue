  ...
  <div class="headline">
    <scroll :listenScroll="listenScroll" :beforeScroll="isBeforeScroll" :pullup="pullup" @scrollToEnd="scrollToEnd" @beforeScroll="beforeScrollLoading" class="headline-content" ref="headlineScroll">
      <div>
        ...
        <listview v-if="listData.length != 0" :listType="listType" :hideLoading="hideLoading" :skip="skip" :limit="limit" @select="slectItem" @nodata="setNodata" @finishLoad="finishLoad" :isloading="isloading" :initData="listData"></listview>
      </div>
    </scroll>
