  ...
  getNameLike: function getNameLike (str) {
    ...
    switch (str) {
      ...
      case '风不止' :
        ...
        break
      case '仙一' :
        return Treasure.find({plus: {$regex: str, $options: '$i'}, important:2}).sort({mapId: 1})
        break
      case '仙二' :
        return Treasure.find({plus: {$regex: str, $options: '$i'}, important:2}).sort({mapId: 1})
        break
      ...
      case '仙四' :
        ...
        break
      case '仙五' :
        return Treasure.find({plus: str, important:2}).sort({mapId: 1})
        break
      case '仙五前' :
        return Treasure.find({plus: str, important:2}).sort({mapId: 1})
        break
      case '仙六' :
        ...
        break
      case '1星' :
        return Treasure.find({level:1}).sort({mapId: 1})
        break
      case '2星' :
        return Treasure.find({level:2}).sort({mapId: 1})
        break
      case '3星' :
        return Treasure.find({level:3}).sort({mapId: 1})
        break
      case '4星' :
        return Treasure.find({level:4}).sort({mapId: 1})
        break
      case '5星' :
        return Treasure.find({level:5}).sort({mapId: 1})
        break
      case '6星' :
        return Treasure.find({level:6}).sort({mapId: 1})
        break
      case '7星' :
        return Treasure.find({level:7}).sort({mapId: 1})
        break
      case '8星' :
        return Treasure.find({level:8}).sort({mapId: 1})
        break
      case '9星' :
        return Treasure.find({level:9}).sort({mapId: 1})
        break
      case '10星' :
        return Treasure.find({level:10}).sort({mapId: 1})
        break
      case '11星' :
        return Treasure.find({level:11}).sort({mapId: 1})
        break
      default:
